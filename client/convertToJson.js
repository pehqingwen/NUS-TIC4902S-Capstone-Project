...
const jsonDataArray = productData.map(product => convertObjectToJson(product));

const fileName = 'allProducts.json';

// Join the JSON strings with commas to create a valid JSON array
const jsonArray = `[${jsonDataArray.join(',')}]`;
